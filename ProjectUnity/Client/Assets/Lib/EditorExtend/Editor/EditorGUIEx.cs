 ...
 */
public class EditorGUILayoutEx : Singleton<EditorGUILayoutEx>
{
    static EditorGUILayoutEx()
    {
        defaultAreaStyle = EditorStyleEx.PixelBoxStyle;
        defaultLabelStyle = EditorStyleEx.BoxHeaderStyle;
    }
    ...
    public FadeArea BeginFadeArea(bool open, string label, string id, GUIStyle areaStyle, GUIStyle labelStyle, float minHeight = 20f)
    {

        Color tmp1 = GUI.color;

        FadeArea fadeArea = BeginFadeArea(open, id, minHeight, areaStyle);
